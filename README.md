<p align="center"><h1>🧠 ChatGPT-Prompts-Jailbreaks-And-More!</h1></p>
...
In this repository, you will find a variety of prompts that can be used with ChatGPT. We encourage you to suggest your own prompts to the list, and to use ChatGPT to generate new prompts as well.
